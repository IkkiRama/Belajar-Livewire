<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addSiswaModal" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        ...
        <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" name="tambah" wire:click.prevent="create()">Tambah Siswa</button>
            </form>
            </div>
        </div>
    </div>
